#import from import.R

#--------------------------------t24_WNT-06h_L  t24_BMP+WNT-06h_L--------------------------
...
# sort by FDR
final.merged.peaks_m1 <- final.merged.peaks_m1[order(final.merged.peaks@elementMetadata$FDR), ]
...
df_ma <- as.data.frame(final.merged.peaks_m1)

# Create the MA plot with additional smooth lines
ggplot(data = df_ma, aes(x = logCPM, y = logFC, col = factor(sig, levels = c("n.s.", "significant")))) + 
  geom_point() + 
  scale_color_manual(values = c("black", "red")) + 
  # Smoothed line for significant points only
  geom_smooth(data = subset(df_ma, sig == "significant"), aes(x = logCPM, y = logFC), 
...
saveRDS(combined_df_m1, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_WNT-06h_L_VS_t24_BMP+WNT-06h_L/combined_df_m1.rds')
...
saveRDS(significant_peaks_m2, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_WNT-06h_L_VS_t24_BMP+WNT-06h_L/significant_peaks_m2.rds')
...
# Convert to data frame for ggplot
df_ma <- as.data.frame(final.merged.peaks_m2)
...
saveRDS(combined_df_m2, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_WNT-06h_L_VS_t24_BMP+WNT-06h_L/combined_df_m2.rds')
...
saveRDS(significant_peaks_m3, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_WNT-06h_L_VS_t24_BMP+WNT-06h_L/significant_peaks_m3.rds')
...
# Convert to data frame for ggplot
df_ma <- as.data.frame(final.merged.peaks_m3)
...
saveRDS(combined_df_m3, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_WNT-06h_L_VS_t24_BMP+WNT-06h_L/combined_df_m3.rds')
...
saveRDS(significant_peaks_m4, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_WNT-06h_L_VS_t24_BMP+WNT-06h_L/significant_peaks_m3.rds')
...
# Convert to data frame for ggplot
df_ma <- as.data.frame(final.merged.peaks_m4)
...
saveRDS(combined_df_m4, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_WNT-06h_L_VS_t24_BMP+WNT-06h_L/combined_df_m4.rds')
