# t06_BMP+WNT vs  t06_WNT    

design <- readRDS("/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/paper_csaw/design.rds")


#method1:
peak.counts.tmm <- readRDS("/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/paper_csaw/peak.counts.tmm.rds")
...
#method2:
peak.counts.loess <- readRDS("/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/paper_csaw/peak.counts.loess.rds")
...
#method3:
counts.local.tmm <- readRDS("/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/paper_csaw/counts.local.tmm.rds")
...
#method 4:
counts.local.loess <- readRDS("/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/paper_csaw/counts.local.loess.rds")
...
#--------------------------------t06_BMP.WNT vs  t06_WNT--------------------------
contr <- makeContrasts(t06_BMP.WNT - t06_WNT, levels = colnames(design))
...
# sort by FDR
final.merged.peaks_m1 <- final.merged.peaks[order(final.merged.peaks@elementMetadata$FDR), ]
...
saveRDS(significant_peaks_m1, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t06_BMP.WNT_vs_t06_WNT/significant_peaks_m1.rds')
...
saveRDS(combined_df_m1, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t06_BMP.WNT_vs_t06_WNT/combined_df_m1.rds')
...
# sort by FDR
final.merged.peaks_m2 <- final.merged.peaks_m2[order(final.merged.peaks@elementMetadata$FDR), ]
...
saveRDS(significant_peaks_m2, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t06_BMP.WNT_vs_t06_WNT/significant_peaks_m2.rds')
...
saveRDS(combined_df_m2, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t06_BMP.WNT_vs_t06_WNT/combined_df_m2.rds')
...
saveRDS(significant_peaks_m3, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t06_BMP.WNT_vs_t06_WNT/significant_peaks_m3.rds')
...
saveRDS(combined_df_m3, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t06_BMP.WNT_vs_t06_WNT/combined_df_m3.rds')
...
saveRDS(significant_peaks_m4, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t06_BMP.WNT_vs_t06_WNT/significant_peaks_m4.rds')
...
saveRDS(combined_df_m4, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t06_BMP.WNT_vs_t06_WNT/combined_df_m4.rds')
