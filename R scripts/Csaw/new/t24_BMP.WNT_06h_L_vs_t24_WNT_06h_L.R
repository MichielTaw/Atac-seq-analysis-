...
/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_BMP.WNT_06h_L_vs_t24_WNT_06h_L

contr <- makeContrasts(t24_BMP.WNT_06h_L - t24_WNT_06h_L, levels = colnames(design))
...
rowData(peak.counts.tmm) <- cbind(rowData(peak.counts.tmm), results_m1$table) # combine GRanges rowdata with differential statistics
...
saveRDS(significant_peaks_m1, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_BMP.WNT_06h_L_vs_t24_WNT_06h_L/significant_peaks_m1.rds')
...
saveRDS(combined_df_m1, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_BMP.WNT_06h_L_vs_t24_WNT_06h_L/combined_df_m1.rds')
...
saveRDS(significant_peaks_m2, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_BMP.WNT_06h_L_vs_t24_WNT_06h_L/significant_peaks_m2.rds')
...
saveRDS(combined_df_m2, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_BMP.WNT_06h_L_vs_t24_WNT_06h_L/combined_df_m2.rds')
...
saveRDS(significant_peaks_m3, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_BMP.WNT_06h_L_vs_t24_WNT_06h_L/significant_peaks_m3.rds')
...
saveRDS(combined_df_m3, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_BMP.WNT_06h_L_vs_t24_WNT_06h_L/combined_df_m3.rds')
...
saveRDS(significant_peaks_m4, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_BMP.WNT_06h_L_vs_t24_WNT_06h_L/significant_peaks_m4.rds')
...
saveRDS(combined_df_m4, file='/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_BMP.WNT_06h_L_vs_t24_WNT_06h_L/combined_df_m4.rds')
...
#------------IMPORT-------
setwd("/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_BMP.WNT_06h_L_vs_t24_WNT_06h_L")


significant_peaks_m1 <- readRDS("/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_BMP.WNT_06h_L_vs_t24_WNT_06h_L/significant_peaks_m1.rds")
significant_peaks_m1$name <- paste0("peak_", 1:length(significant_peaks_m1))


significant_peaks_m2 <- readRDS("/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_BMP.WNT_06h_L_vs_t24_WNT_06h_L/significant_peaks_m2.rds")
significant_peaks_m2$name <- paste0("peak_", 1:length(significant_peaks_m2))


significant_peaks_m3 <- readRDS("/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_BMP.WNT_06h_L_vs_t24_WNT_06h_L/significant_peaks_m3.rds")
significant_peaks_m3$name <- paste0("peak_", 1:length(significant_peaks_m3))


significant_peaks_m4 <- readRDS("/collignon/Tawdarous/atac_seq_lab/results/csaw_result/new_csaw/comparaison_paper/t24_BMP.WNT_06h_L_vs_t24_WNT_06h_L/significant_peaks_m4.rds")
