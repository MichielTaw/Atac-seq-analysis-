...
up_data <- process_homer_data(homer_up_m3_annotated, all_genes_ordered, "Upregulated")
down_data <- process_homer_data(homer_down_m3_annotated, all_genes_ordered, "Downregulated")
