...
input_folder="/collignon/Tawdarous/atac_seq_lab/results/post_alignment/encode"
output_folder="/collignon/Tawdarous/atac_seq_lab/results/post_alignment/encode_chr_renamed"
